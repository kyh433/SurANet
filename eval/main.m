...
Models = {'SINet_V2_convnext_doublefusion_sursup_compare_BackboneF_LOW_?(compare_low)_star'};
...
for d = 1:datasetNum
    ...
    ResPath = [ResDir  Models{1} '/' dataset '-mat/']; % The result will be saved in *.mat file so that you can used it for the next time.
    ...
    for m = 1:modelNum
        ...
        save([ResPath model tag{1}],'Smeasure','wFmeasure', 'MAE', 'threshold_Precion', 'threshold_Recall', 'threshold_Fmeasure', 'adpFmeasure','threshold_Emeasure', 'adpEmeasure');
