...
class EdgeDecoder(nn.Module):
    def __init__(self):
        ...
        self.pred_mask = nn.Conv2d(16, 1, kernel_size=3, stride=1, padding=1, bias=True)
...
class Network(nn.Module):
    ...
    def forward(self, x):
        ...
        S_2_pred=S_2_pred+S_edge_pred

        # diyplot2(xx,S_g_pred,S_edge_pred,ra4_feat,S_5_pred,ra3_feat,S_4_pred,ra2_feat,S_3_pred,ra1_feat,S_2_pred)

        return S_g_pred, S_5_pred, S_4_pred, S_3_pred,S_2_pred,S_edge_pred
