...
class Network(nn.Module):
    ...
    def __init__(self, channel=32, imagenet_pretrained=True):
        ...
        self.conv_concat2 = BasicConv2d(4*channel, channel, 3, padding=1)
        self.conv_concat1 = BasicConv2d(5*channel, channel, 3, padding=1)
    ...
    def forward(self, x):
        ...
        g3_sur,g2_sur,g1_sur,S_sur = self.SRD(x4_rfb, x3_rfb, x2_rfb,x1_rfb)
        ...
        x3_rfb_ = torch.cat((x3_rfb,F3_edge), 1)  #32+64
        ...
        x2_rfb_ = torch.cat((x2_rfb,F2_edge), 1)  #32+96
        ...
        x1_rfb_ = torch.cat((x1_rfb,F1_edge), 1)  #32+128
